...
import 'updaterewards_widget.dart' show UpdaterewardsWidget;
...
class UpdaterewardsModel extends FlutterFlowModel<UpdaterewardsWidget> {
  ...
  bool isDataUploading_uploadDataPdf1 = false;
  FFUploadedFile uploadedLocalFile_uploadDataPdf1 =
  ...
  bool isDataUploading_uploadDataAudio2 = false;
  FFUploadedFile uploadedLocalFile_uploadDataAudio2 =
      FFUploadedFile(bytes: Uint8List.fromList([]), originalFilename: '');

  // Stores action output result for [Backend Call - API (Get upload URL)] action in Button widget.
  ApiCallResponse? signAUDIO;
  // Stores action output result for [Backend Call - Update Row(s)] action in Button widget.
  List<RewardsRow>? uploadrow;
