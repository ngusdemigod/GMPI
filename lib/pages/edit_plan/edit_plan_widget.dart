...
import 'edit_plan_model.dart';
export 'edit_plan_model.dart';

class EditPlanWidget extends StatefulWidget {
  const EditPlanWidget({
    super.key,
    this.title,
    this.description,
    required this.id,
  ...
  @override
  State<EditPlanWidget> createState() => _EditPlanWidgetState();
}
                                  ...
                                  Align(
                                    ...
                                    child: Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          await PartnershipPLANSTable().update(
                                            data: {
                                              'title': _model
