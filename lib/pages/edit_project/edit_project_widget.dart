...
class _EditProjectWidgetState extends State<EditProjectWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.start = widget!.startdate;
      _model.end = widget!.enddate;
      safeSetState(() {});
    });

    _model.switchValue = widget!.status == 'active' ? true : false;
    ...
    _model.tartgetamountTextController ??= TextEditingController(
        text: functions.safeCurrency(widget!.target!, widget!.currency!));
                                                            ...
                                                            return WebViewAware(
                                                              child:
                                                                ...
                                                                title: Text(
                                                                    'Activate project?'),
                                                                content: Text(
                                                                    'This would active the project would you like to proceed?'),
                                                                actions: [
                                                                  TextButton(
                                                                    onPressed: () =>
                                                                        Navigator.pop(
                                                            ...
                                                            return WebViewAware(
                                                              child:
                                                                ...
                                                                title: Text(
                                                                    'Deactivate project?'),
                                                                content: Text(
                                                                    'This would deactivate the project would you like to proceed?'),
                                                                actions: [
                                                                  TextButton(
                                                                    onPressed: () =>
                                                                        Navigator.pop(
                                          ...
                                          await ProjectsTable().update(
                                            data: {
                                              ...
                                              'description': _model
                                                  ...
                                                  .text,
                                              'target_amount': functions
                                                  .formattedToDouble(_model
