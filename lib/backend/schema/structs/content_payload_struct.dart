...
class ContentPayloadStruct extends BaseStruct {
  ContentPayloadStruct({
    String? type,
    String? title,
    String? description,
    String? htmlContent,
  ...
  static ContentPayloadStruct fromMap(Map<String, dynamic> data) =>
      ContentPayloadStruct(
  ...
  static ContentPayloadStruct? maybeFromMap(dynamic data) => data is Map
      ? ContentPayloadStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static ContentPayloadStruct fromSerializableMap(Map<String, dynamic> data) =>
      ContentPayloadStruct(
  ...
  @override
  String toString() => 'ContentPayloadStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is ContentPayloadStruct &&
        type == other.type &&
        title == other.title &&
...
ContentPayloadStruct createContentPayloadStruct({
  String? type,
  String? title,
  String? description,
  String? htmlContent,
